...
urlpatterns = [ 
    ...
    path('igc4/', igc4, name = 'igc4'),
    path('igc5/', igc5, name = 'igc5'),
    path('test_red/',TestRedirectView.as_view(), name = 'test_red_view'),
    path('test_rec/<int:code>/',TestReciveView.as_view(), name = 'test_rec_view')
]